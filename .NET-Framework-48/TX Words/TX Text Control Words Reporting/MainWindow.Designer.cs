...
namespace TXTextControl.Words {
	partial class MainWindow {
		...
		private void InitializeComponent() {
			...
			this.m_rsepSeparator1 = new TXTextControl.Windows.Forms.Ribbon.RibbonSeperator();
			...
			this.m_rmbtnOpenSampleTemplate = new TXTextControl.Windows.Forms.Ribbon.RibbonMenuButton();
			this.m_rbtnSampleInvoiceTemplate = new TXTextControl.Windows.Forms.Ribbon.RibbonButton();
			this.m_rbtnSamplePackingListTemplate = new TXTextControl.Windows.Forms.Ribbon.RibbonButton();
			this.m_rbtnSampleShippingLabelTemplate = new TXTextControl.Windows.Forms.Ribbon.RibbonButton();
			...
			this.m_ctgReportingResult = new TXTextControl.Windows.Forms.Ribbon.ContextualTabGroup();
			this.m_rtMergeResultsTab = new TXTextControl.Windows.Forms.Ribbon.RibbonTab();
			...
			this.m_rtRibbonReportingTab = new TXTextControl.Windows.Forms.Ribbon.RibbonReportingTab();
			...
			this.m_txTextControl.Size = new System.Drawing.Size(644, 628);
			...
			this.m_rbnRibbon.ContextualTabGroups.Add(this.m_ctgReportingResult);
			this.m_rbnRibbon.Controls.Add(this.m_rtRibbonFormattingTab);
			this.m_rbnRibbon.Controls.Add(this.m_rtRibbonInsertTab);
			this.m_rbnRibbon.Controls.Add(this.m_rtRibbonReportingTab);
			...
			this.m_rbnRibbon.SelectedIndex = 3;
			...
			// m_rsepSeparator1
			// 
			this.m_rsepSeparator1.BackColor = System.Drawing.Color.Transparent;
			this.m_rsepSeparator1.Dock = System.Windows.Forms.DockStyle.Top;
			this.m_rsepSeparator1.Font = new System.Drawing.Font("Segoe UI", 9F);
			this.m_rsepSeparator1.Location = new System.Drawing.Point(0, 24);
			this.m_rsepSeparator1.Margin = new System.Windows.Forms.Padding(0, 0, 1, 0);
			this.m_rsepSeparator1.Name = "m_rsepSeparator1";
			this.m_rsepSeparator1.Size = new System.Drawing.Size(191, 5);
			this.m_rsepSeparator1.TabIndex = 0;
			this.m_rsepSeparator1.TabStop = false;
			this.m_rsepSeparator1.Text = "ribbonSeperator1";
			// 
			// m_rbtnNew
			// 
			...
			this.m_rbtnNew.Size = new System.Drawing.Size(195, 38);
			...
			this.m_rbtnOpen.Size = new System.Drawing.Size(195, 38);
			this.m_rbtnOpen.TabIndex = 0;
			this.m_rbtnOpen.Text = "Open...";
			// 
			// m_rmbtnOpenSampleTemplate
			// 
			this.m_rmbtnOpenSampleTemplate.BackColor = System.Drawing.Color.Transparent;
			this.m_rmbtnOpenSampleTemplate.Dock = System.Windows.Forms.DockStyle.Top;
			this.m_rmbtnOpenSampleTemplate.DropDownItems.AddRange(new System.Windows.Forms.Control[] {
            this.m_rbtnSampleInvoiceTemplate,
            this.m_rbtnSamplePackingListTemplate,
            this.m_rbtnSampleShippingLabelTemplate});
			this.m_rmbtnOpenSampleTemplate.Font = new System.Drawing.Font("Segoe UI", 9F);
			this.m_rmbtnOpenSampleTemplate.KeyTip = "";
			this.m_rmbtnOpenSampleTemplate.Location = new System.Drawing.Point(0, 76);
			this.m_rmbtnOpenSampleTemplate.Margin = new System.Windows.Forms.Padding(0, 0, 1, 0);
			this.m_rmbtnOpenSampleTemplate.Name = "m_rmbtnOpenSampleTemplate";
			this.m_rmbtnOpenSampleTemplate.Size = new System.Drawing.Size(195, 38);
			this.m_rmbtnOpenSampleTemplate.TabIndex = 0;
			this.m_rmbtnOpenSampleTemplate.Text = "Open Sample Template";
			// 
			// m_rbtnSampleInvoiceTemplate
			// 
			this.m_rbtnSampleInvoiceTemplate.BackColor = System.Drawing.Color.Transparent;
			this.m_rbtnSampleInvoiceTemplate.DisplayMode = TXTextControl.Windows.Forms.Ribbon.IconTextRelation.NoIconLabeled;
			this.m_rbtnSampleInvoiceTemplate.Dock = System.Windows.Forms.DockStyle.Top;
			this.m_rbtnSampleInvoiceTemplate.Font = new System.Drawing.Font("Segoe UI", 9F);
			this.m_rbtnSampleInvoiceTemplate.KeyTip = "";
			this.m_rbtnSampleInvoiceTemplate.Location = new System.Drawing.Point(0, 0);
			this.m_rbtnSampleInvoiceTemplate.Margin = new System.Windows.Forms.Padding(0, 0, 1, 0);
			this.m_rbtnSampleInvoiceTemplate.Name = "m_rbtnSampleInvoiceTemplate";
			this.m_rbtnSampleInvoiceTemplate.Size = new System.Drawing.Size(142, 24);
			this.m_rbtnSampleInvoiceTemplate.TabIndex = 0;
			this.m_rbtnSampleInvoiceTemplate.Text = "Sample Invoice Template";
			// 
			// m_rbtnSamplePackingListTemplate
			// 
			this.m_rbtnSamplePackingListTemplate.BackColor = System.Drawing.Color.Transparent;
			this.m_rbtnSamplePackingListTemplate.DisplayMode = TXTextControl.Windows.Forms.Ribbon.IconTextRelation.NoIconLabeled;
			this.m_rbtnSamplePackingListTemplate.Dock = System.Windows.Forms.DockStyle.Top;
			this.m_rbtnSamplePackingListTemplate.Font = new System.Drawing.Font("Segoe UI", 9F);
			this.m_rbtnSamplePackingListTemplate.KeyTip = "";
			this.m_rbtnSamplePackingListTemplate.Location = new System.Drawing.Point(0, 0);
			this.m_rbtnSamplePackingListTemplate.Margin = new System.Windows.Forms.Padding(0, 0, 1, 0);
			this.m_rbtnSamplePackingListTemplate.Name = "m_rbtnSamplePackingListTemplate";
			this.m_rbtnSamplePackingListTemplate.Size = new System.Drawing.Size(167, 24);
			this.m_rbtnSamplePackingListTemplate.TabIndex = 0;
			this.m_rbtnSamplePackingListTemplate.Text = "Sample Packing List Template";
			// 
			// m_rbtnSampleShippingLabelTemplate
			// 
			this.m_rbtnSampleShippingLabelTemplate.BackColor = System.Drawing.Color.Transparent;
			this.m_rbtnSampleShippingLabelTemplate.DisplayMode = TXTextControl.Windows.Forms.Ribbon.IconTextRelation.NoIconLabeled;
			this.m_rbtnSampleShippingLabelTemplate.Dock = System.Windows.Forms.DockStyle.Top;
			this.m_rbtnSampleShippingLabelTemplate.Font = new System.Drawing.Font("Segoe UI", 9F);
			this.m_rbtnSampleShippingLabelTemplate.KeyTip = "";
			this.m_rbtnSampleShippingLabelTemplate.Location = new System.Drawing.Point(0, 0);
			this.m_rbtnSampleShippingLabelTemplate.Margin = new System.Windows.Forms.Padding(0, 0, 1, 0);
			this.m_rbtnSampleShippingLabelTemplate.Name = "m_rbtnSampleShippingLabelTemplate";
			this.m_rbtnSampleShippingLabelTemplate.Size = new System.Drawing.Size(182, 24);
			this.m_rbtnSampleShippingLabelTemplate.TabIndex = 0;
			this.m_rbtnSampleShippingLabelTemplate.Text = "Sample Shipping Label Template";
			// 
			// m_rbtnSave
			// 
			...
			this.m_rbtnSave.Location = new System.Drawing.Point(0, 114);
			this.m_rbtnSave.Margin = new System.Windows.Forms.Padding(0, 0, 1, 0);
			this.m_rbtnSave.Name = "m_rbtnSave";
			this.m_rbtnSave.Size = new System.Drawing.Size(195, 38);
			...
			this.m_rbtnSaveAs.Location = new System.Drawing.Point(0, 152);
			this.m_rbtnSaveAs.Margin = new System.Windows.Forms.Padding(0, 0, 1, 0);
			this.m_rbtnSaveAs.Name = "m_rbtnSaveAs";
			this.m_rbtnSaveAs.Size = new System.Drawing.Size(195, 38);
			...
			this.m_rsbtnPrint.Location = new System.Drawing.Point(0, 190);
			this.m_rsbtnPrint.Margin = new System.Windows.Forms.Padding(0, 0, 1, 0);
			this.m_rsbtnPrint.Name = "m_rsbtnPrint";
			this.m_rsbtnPrint.Size = new System.Drawing.Size(195, 38);
			...
			this.m_rbtnPrint.Size = new System.Drawing.Size(85, 38);
			this.m_rbtnPrint.TabIndex = 0;
			this.m_rbtnPrint.Text = "Print...";
			// 
			// m_rbtnPrintQuick
			// 
			...
			this.m_rbtnPrintQuick.Size = new System.Drawing.Size(110, 38);
			this.m_rbtnPrintQuick.TabIndex = 0;
			this.m_rbtnPrintQuick.Text = "Print Quick";
			// 
			// m_rbtnPrintPreview
			// 
			...
			this.m_rbtnPrintPreview.Size = new System.Drawing.Size(120, 38);
			this.m_rbtnPrintPreview.TabIndex = 0;
			this.m_rbtnPrintPreview.Text = "Print Preview";
			// 
			// m_rtbtnAbout
			// 
			...
			// 
			this.m_ctgReportingResult.BackColor = System.Drawing.Color.SkyBlue;
			this.m_ctgReportingResult.ContextualTabs.Add(this.m_rtMergeResultsTab);
			this.m_ctgReportingResult.Header = "Reporting";
			this.m_ctgReportingResult.Name = "m_ctgReportingResult";
			// 
			// m_rtMergeResultsTab
			// 
			this.m_rtMergeResultsTab.KeyTip = "";
			this.m_rtMergeResultsTab.Location = new System.Drawing.Point(0, 0);
			this.m_rtMergeResultsTab.Name = "m_rtMergeResultsTab";
			this.m_rtMergeResultsTab.Size = new System.Drawing.Size(200, 40);
			this.m_rtMergeResultsTab.TabIndex = 0;
			this.m_rtMergeResultsTab.Text = "Export";
			// 
			...
			this.m_rtRibbonFormattingTab.StylesSidebar = this.m_sbSidebarLeft;
			...
			this.m_sbSidebarBottom.Size = new System.Drawing.Size(669, 18);
			...
			// m_sbSidebarRight
			// 
			this.m_sbSidebarRight.ContentLayout = TXTextControl.Windows.Forms.Sidebar.SidebarContentLayout.FieldNavigator;
			...
			this.m_sbSidebarRight.Location = new System.Drawing.Point(977, 149);
			...
			this.m_sbSidebarRight.ShowPinButton = false;
			this.m_sbSidebarRight.Size = new System.Drawing.Size(257, 671);
			...
			// 
			this.m_rtRibbonReportingTab.FieldNavigatorSidebar = this.m_sbSidebarRight;
			this.m_rtRibbonReportingTab.Location = new System.Drawing.Point(4, 24);
			this.m_rtRibbonReportingTab.Name = "m_rtRibbonReportingTab";
			this.m_rtRibbonReportingTab.Size = new System.Drawing.Size(1226, 90);
			this.m_rtRibbonReportingTab.TabIndex = 9;
			// 
			...
			this.m_rbHorizontalRulerBar.Size = new System.Drawing.Size(669, 25);
		...
		private TXTextControl.Windows.Forms.Ribbon.RibbonSeperator m_rsepSeparator1;
		private Windows.Forms.Ribbon.Ribbon m_rbnRibbon;
		private Windows.Forms.Ribbon.RibbonFormattingTab m_rtRibbonFormattingTab;
		private Windows.Forms.Ribbon.RibbonInsertTab m_rtRibbonInsertTab;
		private Windows.Forms.Ribbon.RibbonReportingTab m_rtRibbonReportingTab;
		private Windows.Forms.Ribbon.ContextualTabGroup m_ctgReportingResult;
		private Windows.Forms.Ribbon.RibbonTab m_rtMergeResultsTab;
		private Windows.Forms.Ribbon.RibbonMenuButton m_rmbtnOpenSampleTemplate;
		private Windows.Forms.Ribbon.RibbonButton m_rbtnSampleInvoiceTemplate;
		private Windows.Forms.Ribbon.RibbonButton m_rbtnSamplePackingListTemplate;
		private Windows.Forms.Ribbon.RibbonButton m_rbtnSampleShippingLabelTemplate;
