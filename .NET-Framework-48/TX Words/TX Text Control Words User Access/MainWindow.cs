	...
	public partial class MainWindow : RibbonForm {
        ...
        **-----------------------------------------------------------------------------------------------------*/
		private void SetAppMenuBehavior() {
			...
			// Sign In:
			m_rbtnSignIn.Click += SignIn_Click;

			// [Current User]:
			m_rbtnAccountSettings.Click += AccountSettings_Click; // Account Settings (Drop Down Button)
			m_rbtnSignOut.Click += SignOut_Click; // Sign Out (Drop Down Button)
