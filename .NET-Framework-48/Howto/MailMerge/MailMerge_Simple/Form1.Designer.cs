namespace MailMerge_Simple {
	partial class Form1 {
		...
		private void InitializeComponent() {
			...
			this.m_tmiApplicationFields = new System.Windows.Forms.ToolStripMenuItem();
			this.m_tmiAdd = new System.Windows.Forms.ToolStripMenuItem();
			this.m_tmiProperties = new System.Windows.Forms.ToolStripMenuItem();
			...
			// 
			this.m_tmiApplicationFields.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] {
            this.m_tmiAdd,
            this.m_tmiProperties});
			this.m_tmiApplicationFields.Name = "m_tmiApplicationFields";
			this.m_tmiApplicationFields.Size = new System.Drawing.Size(113, 20);
			this.m_tmiApplicationFields.Text = "&Application Fields";
			this.m_tmiApplicationFields.DropDownOpening += new System.EventHandler(this.ApplicationFields_DropDownOpening);
			// 
			// m_tmiAdd
			// 
			this.m_tmiAdd.Name = "m_tmiAdd";
			this.m_tmiAdd.Size = new System.Drawing.Size(136, 22);
			this.m_tmiAdd.Text = "&Add";
			// 
			// m_tmiProperties
			// 
			this.m_tmiProperties.Name = "m_tmiProperties";
			this.m_tmiProperties.Size = new System.Drawing.Size(136, 22);
			this.m_tmiProperties.Text = "&Properties...";
			this.m_tmiProperties.Click += new System.EventHandler(this.Properties_Click);
			// 
			// m_tmiMailMerge
			// 
			...
			this.m_tmiMailMerge.DropDownOpening += new System.EventHandler(this.MailMerge_DropDownOpening);
			// 
			// m_tmiMerge
			// 
			...
			this.Text = "Howto: Mail Merge - Sample: Simple Mail Merge";
		...
		private System.Windows.Forms.ToolStripMenuItem m_tmiApplicationFields;
		private System.Windows.Forms.ToolStripMenuItem m_tmiAdd;
		private System.Windows.Forms.ToolStripMenuItem m_tmiProperties;
