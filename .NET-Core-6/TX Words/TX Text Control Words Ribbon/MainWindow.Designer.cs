...
namespace TXTextControl.Words {
	partial class MainWindow {
		...
		private void InitializeComponent() {
			...
			this.m_rtbtnDocumentSettings = new TXTextControl.Windows.Forms.Ribbon.RibbonToggleButton();
			...
			this.m_rbtnExit = new TXTextControl.Windows.Forms.Ribbon.RibbonButton();
			...
			this.m_rtRibbonPageLayoutTab = new TXTextControl.Windows.Forms.Ribbon.RibbonPageLayoutTab();
			this.m_rtRibbonViewTab = new TXTextControl.Windows.Forms.Ribbon.RibbonViewTab();
			this.m_rtRibbonReferencesTab = new TXTextControl.Windows.Forms.Ribbon.RibbonReferencesTab();
			this.m_rtRibbonProofingTab = new TXTextControl.Windows.Forms.Ribbon.RibbonProofingTab();
			...
			this.m_txTextControl.Size = new System.Drawing.Size(607, 628);
			...
			this.m_rbnRibbon.Controls.Add(this.m_rtRibbonPageLayoutTab);
			this.m_rbnRibbon.Controls.Add(this.m_rtRibbonViewTab);
			this.m_rbnRibbon.Controls.Add(this.m_rtRibbonReferencesTab);
			this.m_rbnRibbon.Controls.Add(this.m_rtRibbonProofingTab);
			...
			this.m_rbnRibbon.SelectedIndex = 9;
			...
			// 
			this.m_rtbtnDocumentSettings.BackColor = System.Drawing.Color.Transparent;
			this.m_rtbtnDocumentSettings.Dock = System.Windows.Forms.DockStyle.Top;
			this.m_rtbtnDocumentSettings.Font = new System.Drawing.Font("Segoe UI", 9F);
			this.m_rtbtnDocumentSettings.KeyTip = "";
			this.m_rtbtnDocumentSettings.Location = new System.Drawing.Point(0, 190);
			this.m_rtbtnDocumentSettings.Margin = new System.Windows.Forms.Padding(0, 0, 1, 0);
			this.m_rtbtnDocumentSettings.Name = "m_rtbtnDocumentSettings";
			this.m_rtbtnDocumentSettings.Size = new System.Drawing.Size(191, 38);
			this.m_rtbtnDocumentSettings.TabIndex = 0;
			this.m_rtbtnDocumentSettings.Text = "Document Settings";
			// 
			// m_rsepSeparator1
			// 
			...
			this.m_rsepSeparator1.Location = new System.Drawing.Point(0, 228);
			...
			this.m_rtbtnAbout.Location = new System.Drawing.Point(0, 233);
			this.m_rtbtnAbout.Margin = new System.Windows.Forms.Padding(0, 0, 1, 0);
			this.m_rtbtnAbout.Name = "m_rtbtnAbout";
			this.m_rtbtnAbout.Size = new System.Drawing.Size(191, 38);
			this.m_rtbtnAbout.TabIndex = 0;
			this.m_rtbtnAbout.Text = "About";
			// 
			// m_rbtnExit
			// 
			this.m_rbtnExit.BackColor = System.Drawing.Color.Transparent;
			this.m_rbtnExit.Dock = System.Windows.Forms.DockStyle.Top;
			this.m_rbtnExit.Font = new System.Drawing.Font("Segoe UI", 9F);
			this.m_rbtnExit.KeyTip = "";
			this.m_rbtnExit.Location = new System.Drawing.Point(0, 271);
			this.m_rbtnExit.Margin = new System.Windows.Forms.Padding(0, 0, 1, 0);
			this.m_rbtnExit.Name = "m_rbtnExit";
			this.m_rbtnExit.Size = new System.Drawing.Size(191, 38);
			this.m_rbtnExit.TabIndex = 0;
			this.m_rbtnExit.Text = "Exit";
			// 
			// m_ctgTableTools
			// 
			...
			this.m_sbSidebarBottom.Size = new System.Drawing.Size(632, 18);
			...
			this.m_sbSidebarRight.IsShown = false;
			this.m_sbSidebarRight.Location = new System.Drawing.Point(940, 149);
			...
			this.m_sbSidebarRight.Size = new System.Drawing.Size(294, 671);
			this.m_sbSidebarRight.TabIndex = 8;
			this.m_sbSidebarRight.Text = "m_sbVerticalSidebarRight";
			...
			// 
			this.m_rtRibbonPageLayoutTab.Location = new System.Drawing.Point(4, 24);
			this.m_rtRibbonPageLayoutTab.Name = "m_rtRibbonPageLayoutTab";
			this.m_rtRibbonPageLayoutTab.Size = new System.Drawing.Size(1226, 90);
			this.m_rtRibbonPageLayoutTab.TabIndex = 3;
			// 
			// m_rtRibbonViewTab
			// 
			this.m_rtRibbonViewTab.Location = new System.Drawing.Point(4, 24);
			this.m_rtRibbonViewTab.Name = "m_rtRibbonViewTab";
			this.m_rtRibbonViewTab.Size = new System.Drawing.Size(1226, 90);
			this.m_rtRibbonViewTab.TabIndex = 4;
			// 
			// m_rtRibbonReferencesTab
			// 
			this.m_rtRibbonReferencesTab.Location = new System.Drawing.Point(4, 24);
			this.m_rtRibbonReferencesTab.Name = "m_rtRibbonReferencesTab";
			this.m_rtRibbonReferencesTab.Size = new System.Drawing.Size(1226, 90);
			this.m_rtRibbonReferencesTab.TabIndex = 5;
			// 
			// m_rtRibbonProofingTab
			// 
			this.m_rtRibbonProofingTab.CommentsHorizontalSidebar = this.m_sbSidebarBottom;
			this.m_rtRibbonProofingTab.CommentsSidebar = this.m_sbSidebarRight;
			this.m_rtRibbonProofingTab.Location = new System.Drawing.Point(4, 24);
			this.m_rtRibbonProofingTab.Name = "m_rtRibbonProofingTab";
			this.m_rtRibbonProofingTab.Size = new System.Drawing.Size(1226, 90);
			this.m_rtRibbonProofingTab.TabIndex = 6;
			this.m_rtRibbonProofingTab.TrackedChangesHorizontalSidebar = this.m_sbSidebarBottom;
			this.m_rtRibbonProofingTab.TrackedChangesSidebar = this.m_sbSidebarLeft;
			// 
			// m_sbSidebarLeft
			// 
			...
			this.m_rbHorizontalRulerBar.Size = new System.Drawing.Size(632, 25);
		...
		private TXTextControl.Windows.Forms.Ribbon.RibbonPageLayoutTab m_rtRibbonPageLayoutTab;
		private TXTextControl.Windows.Forms.Ribbon.RibbonViewTab m_rtRibbonViewTab;
		private TXTextControl.Windows.Forms.Ribbon.RibbonReferencesTab m_rtRibbonReferencesTab;
		private TXTextControl.Windows.Forms.Ribbon.RibbonProofingTab m_rtRibbonProofingTab;
		...
		private TXTextControl.Windows.Forms.Ribbon.RibbonReportingTab m_rtRibbonReportingTab;
		...
		private TXTextControl.Windows.Forms.Ribbon.RibbonToggleButton m_rtbtnDocumentSettings;
		private TXTextControl.Windows.Forms.Ribbon.RibbonSeperator m_rsepSeparator1;
		private TXTextControl.Windows.Forms.Ribbon.RibbonButton m_rbtnExit;
